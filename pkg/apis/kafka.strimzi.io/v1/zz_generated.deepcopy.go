...
func (in *EntityTopicOperatorSpec) DeepCopyInto(out *EntityTopicOperatorSpec) {
	*out = *in
	if in.ReconciliationIntervalMs != nil {
		in, out := &in.ReconciliationIntervalMs, &out.ReconciliationIntervalMs
		*out = new(int64)
		**out = **in
	}
...
func (in *GenericKafkaListenerConfiguration) DeepCopyInto(out *GenericKafkaListenerConfiguration) {
	*out = *in
	...
	if in.MaxConnectionCreationRate != nil {
		in, out := &in.MaxConnectionCreationRate, &out.MaxConnectionCreationRate
		*out = new(int32)
		**out = **in
	}
...
func (in *KafkaAuthorization) DeepCopyInto(out *KafkaAuthorization) {
	*out = *in
	...
	if in.GrantsMaxIdleTimeSeconds != nil {
		in, out := &in.GrantsMaxIdleTimeSeconds, &out.GrantsMaxIdleTimeSeconds
		*out = new(int32)
		**out = **in
	}
	...
	if in.GrantsGcPeriodSeconds != nil {
		in, out := &in.GrantsGcPeriodSeconds, &out.GrantsGcPeriodSeconds
		*out = new(int32)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KafkaBridgeHttpTls) DeepCopyInto(out *KafkaBridgeHttpTls) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KafkaBridgeHttpTls.
func (in *KafkaBridgeHttpTls) DeepCopy() *KafkaBridgeHttpTls {
	if in == nil {
		return nil
	}
	out := new(KafkaBridgeHttpTls)
...
func (in *KafkaClientAuthentication) DeepCopyInto(out *KafkaClientAuthentication) {
	*out = *in
	...
	if in.HttpRetryPauseMs != nil {
		in, out := &in.HttpRetryPauseMs, &out.HttpRetryPauseMs
		*out = new(int32)
		**out = **in
	}
...
func (in *KafkaMirrorMaker2Spec) DeepCopyInto(out *KafkaMirrorMaker2Spec) {
	*out = *in
	if in.Target != nil {
		...
		*out = new(KafkaMirrorMaker2TargetClusterSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.Mirrors != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KafkaMirrorMaker2TargetClusterSpec) DeepCopyInto(out *KafkaMirrorMaker2TargetClusterSpec) {
	*out = *in
	if in.Tls != nil {
		in, out := &in.Tls, &out.Tls
		*out = new(ClientTls)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KafkaMirrorMaker2TargetClusterSpec.
func (in *KafkaMirrorMaker2TargetClusterSpec) DeepCopy() *KafkaMirrorMaker2TargetClusterSpec {
	if in == nil {
		return nil
	}
	out := new(KafkaMirrorMaker2TargetClusterSpec)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KafkaRebalanceProgress) DeepCopyInto(out *KafkaRebalanceProgress) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KafkaRebalanceProgress.
func (in *KafkaRebalanceProgress) DeepCopy() *KafkaRebalanceProgress {
	if in == nil {
		return nil
	}
	out := new(KafkaRebalanceProgress)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MetricsConfig) DeepCopyInto(out *MetricsConfig) {
	*out = *in
	...
	if in.Values != nil {
		...
		*out = new(StrimziMetricsReporterValues)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MountedArtifact) DeepCopyInto(out *MountedArtifact) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MountedArtifact.
func (in *MountedArtifact) DeepCopy() *MountedArtifact {
	if in == nil {
		return nil
	}
	out := new(MountedArtifact)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MountedPlugin) DeepCopyInto(out *MountedPlugin) {
	*out = *in
	if in.Artifacts != nil {
		...
		*out = make([]MountedArtifact, len(*in))
		copy(*out, *in)
	}
	return
}
...
func (in *Output) DeepCopyInto(out *Output) {
	*out = *in
	if in.AdditionalPushOptions != nil {
		in, out := &in.AdditionalPushOptions, &out.AdditionalPushOptions
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.AdditionalBuildOptions != nil {
		in, out := &in.AdditionalBuildOptions, &out.AdditionalBuildOptions
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	return
...
func (in *QuotasPlugin) DeepCopyInto(out *QuotasPlugin) {
	*out = *in
	...
	if in.MinAvailableRatioPerVolume != nil {
		in, out := &in.MinAvailableRatioPerVolume, &out.MinAvailableRatioPerVolume
		*out = new(float64)
		**out = **in
	}
	if in.MinAvailableBytesPerVolume != nil {
		in, out := &in.MinAvailableBytesPerVolume, &out.MinAvailableBytesPerVolume
		*out = new(int64)
		**out = **in
	}
	if in.ControllerMutationRate != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StrimziMetricsReporterValues) DeepCopyInto(out *StrimziMetricsReporterValues) {
	*out = *in
	if in.AllowList != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StrimziMetricsReporterValues.
func (in *StrimziMetricsReporterValues) DeepCopy() *StrimziMetricsReporterValues {
	if in == nil {
		return nil
	}
	out := new(StrimziMetricsReporterValues)
