...
// CoreV1Client is used to interact with features provided by the core.strimzi.io group.
type CoreV1Client struct {
	restClient rest.Interface
}

func (c *CoreV1Client) StrimziPodSets(namespace string) StrimziPodSetInterface {
...
func setConfigDefaults(config *rest.Config) {
	gv := corestrimziiov1.SchemeGroupVersion
