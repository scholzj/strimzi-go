...
type CoreV1beta2Interface interface {
	...
	StrimziPodSetsGetter
}

// CoreV1beta2Client is used to interact with features provided by the core.strimzi.io group.
type CoreV1beta2Client struct {
	restClient rest.Interface
}

func (c *CoreV1beta2Client) StrimziPodSets(namespace string) StrimziPodSetInterface {
	return newStrimziPodSets(c, namespace)
}
...
func setConfigDefaults(config *rest.Config) error {
	gv := corestrimziiov1beta2.SchemeGroupVersion
