...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	switch resource {
	// Group=core.strimzi.io, Version=v1
	case v1.SchemeGroupVersion.WithResource("strimzipodsets"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Core().V1().StrimziPodSets().Informer()}, nil
	...
	case kafkastrimziiov1.SchemeGroupVersion.WithResource("kafkas"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Kafka().V1().Kafkas().Informer()}, nil
	case kafkastrimziiov1.SchemeGroupVersion.WithResource("kafkabridges"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Kafka().V1().KafkaBridges().Informer()}, nil
	case kafkastrimziiov1.SchemeGroupVersion.WithResource("kafkaconnects"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Kafka().V1().KafkaConnects().Informer()}, nil
	case kafkastrimziiov1.SchemeGroupVersion.WithResource("kafkaconnectors"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Kafka().V1().KafkaConnectors().Informer()}, nil
	case kafkastrimziiov1.SchemeGroupVersion.WithResource("kafkamirrormaker2s"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Kafka().V1().KafkaMirrorMaker2s().Informer()}, nil
	case kafkastrimziiov1.SchemeGroupVersion.WithResource("kafkanodepools"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Kafka().V1().KafkaNodePools().Informer()}, nil
	case kafkastrimziiov1.SchemeGroupVersion.WithResource("kafkarebalances"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Kafka().V1().KafkaRebalances().Informer()}, nil
	case kafkastrimziiov1.SchemeGroupVersion.WithResource("kafkatopics"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Kafka().V1().KafkaTopics().Informer()}, nil
	case kafkastrimziiov1.SchemeGroupVersion.WithResource("kafkausers"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Kafka().V1().KafkaUsers().Informer()}, nil
