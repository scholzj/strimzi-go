...
func NewResource() *kafkav1beta2.KafkaTopic {
...
func UpdatedResource(oldResource *kafkav1beta2.KafkaTopic) *kafkav1beta2.KafkaTopic {
...
func AssertResource(t *testing.T, r1, r2 *kafkav1beta2.KafkaTopic) {
...
func TestKafkaTopicCreateUpdateDelete(t *testing.T) {
	...
	// Assert the resource
	AssertResource(t, newResource, actualResource)

	// Update the resource
	updatedResource := UpdatedResource(actualResource)
	...
	// Assert the resource
	AssertResource(t, updatedResource, actualResource)
